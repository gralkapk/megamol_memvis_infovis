...
private:
    ...
    void clusterYRange(float * const data, stdplugin::datatools::floattable::CallFloatTableData::ColumnInfo & ci, size_t selector, size_t numEntries, size_t numCol);

    core::CallerSlot metaRequestSlot;

    core::CallerSlot transFuncSlot;
    ...
    std::vector<vislib::math::Point<float, 3>> pointDataPoints;

    core::param::ParamSlot alphaScalingParam;
    core::param::ParamSlot attenuateSubpixelParam;

    core::param::ParamSlot colSelectParam;
    core::param::ParamSlot descSelectParam;

    size_t colorColIdx;
    size_t descColIdx;
    vislib::math::Dimension<float, 2> minMaxColorCol;
